...
The first generates \mbox{RDF-star} graphs from scientific software documentation~\parencite{iglesias2017fair-software-bp}, 
...
\begin{captionedlisting}{lst:chp4_semmeddb_entity}{ENTITY.csv snippet.}
\centering
\begin{tabular}{c}
\hspace{-0.7em}
{
...
\begin{captionedlisting}{lst:chp4_semmeddb_pred}{PREDICATION.csv snippet.}
\centering
\begin{tabular}{c}
\hspace{-1em}
{
...
\begin{captionedlisting}{lst:chp4_semmeddb_predaux}{PREDICATION\_AUX.csv snippet.}
\centering
\begin{tabular}{c}
\hspace{-7em}
{
