\section{Mapping Rules for RDF-star: RML-star \ana{cambiar a algo más general}}
...
%In the late years, the RDF-star~\citep{hartig2017foundations} approach for reification has gained popularity. Along with its expansions, different semantic web technologies have been updated to include this new syntax\footnote{\url{https://w3c.github.io/rdf-star/implementations}}. This section describes one of these updates related to building RDF-star graphs: RML-star. \ana{esto no liga del todo bien con lo anterior}
...
\ana{intro más amplia para rdf-stark coger de paper de rml, para motivación tb, si no queda repetitivo con CM. y explicar más qué pasa en esta sección }
