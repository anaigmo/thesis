...
\caption{The \mbox{RML-star} module (represented using the Chowlk notation~(\cite{feria2022chowlk})). The RML-star resources are highlighted in orange, while the rest of the represented ontology belongs to the RML-Core module.}
