\section{Mapping Rules for RDF: Conceptual Mapping Ontology}
...
This section presents the purpose, scope, and requirements of the Conceptual Mapping Ontology. In addition, it also describes from where and how the requirements are extracted: analysing the mapping languages (presented as a comparative framework) and the Mapping Challenges proposed by the community. \ana{introducir que del framework se sacan los requisitos, no poner como una sucsección más}
...
\ana{no sé si dejar esto o rehacer y poner de drugs4covid, para que no sean datos de juguete}
