...
The technologies revolving mappings are a perfect fit for composing modular, automated approaches to be integrated in larger pipelines that manage knowledge graphs \ana{ejs del workshop, papers de KG lifecycle}. However, these technologies are yet relatively recent, and as mentioned before, struggle with a wider adoption. Still, the last few years have seen an increased effort for being refined and optimized \ana{cite ontop y papers ME}, to reduce the learning curve and to prove their benefits with respect to ad-hoc approaches \ana{igual reorientar frase, citar paper master bio2rdf}. Hence, \textbf{there is a lack on research to prove how this technologies can improve not only in KG construction scenarios, but also the beneficial role they can play in KG evolution} with respect to other more mature technologies.  
