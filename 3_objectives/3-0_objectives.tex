...
\begin{enumerate}
    ...
    \item[\textbf{R4}] The implementations proposed are not fully compliant with all modules of the new RML release on 2023~\parencite{iglesias2023rml}. 
