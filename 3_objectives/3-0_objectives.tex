...
\begin{enumerate}
    ...
    \item[\textbf{O1}] To understand and gather the necessities for knowledge graph construction from heterogeneous data sources, thus supporting the evolution of existing mapping languages to address the most relevant ones. 
