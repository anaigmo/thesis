...
\begin{enumerate}
    ...
    \item[\textbf{C3}] \textcolor{red}{\textbf{Development of new features for the RML mapping language}} to address the limitations of the language according to the new needs in knowledge graph construction identified. We focus on the development of the extension to create RDF-star graphs. 
\end{enumerate}
