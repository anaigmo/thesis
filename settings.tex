...
\lstdefinelanguage{yarrrml}{
	keywords=[1]{mappings, sources, s, po, function, parameters, value, parameter, prefixes, athletes, quoted},	% types; money and time units
...
\lstdefinelanguage{yarrrmlstar}{
	keywords=[1]{quoted},	
	keywordstyle=[1]\color{fulvous}\bfseries,
	identifierstyle=\color{black},
	sensitive=true,
	comment=[l]{//},
	morecomment=[s]{/*}{*/},
...
\lstdefinelanguage{rmlstar}{
        alsoletter=:-,
	keywords=[1]{rml:datatypeMap, rml:languageMap, rml:quotedTriplesMap, rml:AssertedTriplesMap},	
	keywordstyle=[1]\color{fulvous}\bfseries,
	identifierstyle=\color{black},
	sensitive=false,
	comment=[l]{@},
