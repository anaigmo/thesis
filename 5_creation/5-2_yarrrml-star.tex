...
Test cases are a common method to evaluate the conformance of a system~\cite{arenas2023morphstar,heyvaert2019conformance}. 
%with respect to a language/syntax specification 
%(see for example). 
To the best of our knowledge, previous R2RML~\cite{boris2012r2rml} and RML~\cite{heyvaert2019conformance} test cases were not translated to any human-friendly serialization (e.g., YARRRML).
...
We compare a set of user-friendly serializations and languages, namely SMS2~\cite{sms2}, XRM~\cite{xrm}, ShExML~\cite{Garcia-Gonzalez2020shexml} and YARRRML~\cite{Heyvaert2018yarrrml} incorporating the updates described in \cref{sec:chp5_yarrrml-desc}, regarding their expressiveness. 
