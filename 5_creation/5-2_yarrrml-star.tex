...
%such as SDM-RDFizer~\citep{iglesias2020sdm} or Morph-KGC~\citep{arenas2022morph}.
...
Test cases are a common method to evaluate the conformance of a system~\citep{arenas2023morph,heyvaert2019conformance}. 
...
%To avoid starting from scratch, we rely on the test cases proposed by R2RML~\citep{R2RML_test_cases} first, that were also extended for RML~\citep{heyvaert2019conformance}. 
...
%YARRRML was developed to be a user-friendly syntax for the RML mapping language~\citep{heyvaert2018yarrrml}. There have been proposed more syntaxes with the same purpose, such as Stardog's SMS2 for R2RML and Zazuko's XRM for [R2]RML and CSVW.
...
%\Cref{tab:chp5_eng-comparison} shows how the different systems compare to YARRRML-translator~\citep{chaves2023translator}. 
