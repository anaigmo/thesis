...
\multirow{15}{*}{\textbf{RDF-based}}   & R2RML           & \parencite{das2012r2rml}\\ \cmidrule{2-3} 
...
\multirow{6}{*}{\textbf{SPARQL-based}} & XSPARQL         & \parencite{Bischof2012xsparql,xsparql}\\ \cmidrule{2-3} 
                              & SPARQL-Generate &     
...
\noindent\textbf{Facade-X}~\parencite{daga2021facade}
...
\noindent\textbf{Helio}~\parencite{cimmino2022helio} is a JSON-based language that provides rich possibilities for heterogeneous data formats and accesses, as well as for linking resources further than joins, commonly used in other mapping languages, and transformation functions.  
