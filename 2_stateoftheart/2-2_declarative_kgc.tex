...
This group is integrated by languages that leverage the SPARQL query language, usually by extending its features to describe non-RDF data sources~\citep{harris2013sparql}. 


\noindent\textbf{XSPARQL}~\citep{Bischof2012xsparql}

\noindent\textbf{TARQL}~\citep{tarql}

\noindent\textbf{SPARQL-Generate}~\citep{Lefrancois2017sparqlgenerate}

\noindent\textbf{SPARQL-Anything}~\citep{asprino2023sparql-anything}

\noindent\textbf{Sansa/whatever}~\citep{stadler2023spark}
