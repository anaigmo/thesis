...
\fancyhead[RO]{\leftmark}       % Define the header for odd and even pages
...
\pagenumbering{roman}			    % roman page numbing 
...
\appendix
\include{appendix/appendix-cm}
\include{appendix/appendix-mapeathor}
